...
class AccountInvoice(models.Model):
    ...
    def export_invoice_magento(self, wizard=True):
        ...
        for invoice in self:
            ...
            if (create_invoice_on == 'in_payment_paid'
                ...
                log_line = invoice.call_export_invoice_api(instance, log_line)
            else:
                if wizard:
    ...
    def call_export_invoice_api(self, instance, log_line):
        """
        ...
        try:
            ...
            """)
            log_line = log_line.create_common_log_line_ept(message=message, order_ref=sale_order.name,
